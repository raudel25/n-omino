...
public class PrinterLongana : PrinterDomino
{
    ...
    public override void LocationTable<T>(TableGame<T> table)
    {
        ...
        for (var i = 0; i < table.TableNode[0].Connections.Length; i++)
        {
            ...
            var type = Classic ? TypeToken.DominoVC : TypeToken.DominoV;
        ...
        ExecuteTableEvent(locations);
    }

    public override Printer Reset()
    {
        return new PrinterLongana(Speed, Classic);
    }
}