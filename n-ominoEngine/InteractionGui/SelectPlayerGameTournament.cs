...
{
    public string Description { get; } = "Forma de determinar los jugadores que participan en el torneo";
    ...
    {
        new ParamSelect("Asignacion clasica de los juegadores", "Todos los jugadores participan en el juego", 0),
